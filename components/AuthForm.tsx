...
export function AuthForm({
  ...
  const renderVerificationAlert = () => {
    ...
    return (
      <Alert variant={verificationSent ? "default" : "destructive"} className={verificationSent ? "mb-4 bg-neutral-100 text-neutral-800 border-neutral-200 dark:bg-neutral-800/50 dark:text-neutral-200 dark:border-neutral-700" : "mb-4"}>
      ...
      <CardContent className="space-y-2 px-6 py-2">
        <div className="grid gap-6">
          <div className="grid gap-4">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Input
                    ...
                    {...register("name")}
                    className={cn(
                      "h-11 rounded-sm pl-3 focus-visible:ring-neutral-400 focus-visible:border-neutral-500",
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                ...
                {isSignIn && (
                  <Button
                    variant="link"
                    className="px-0 font-normal text-xs text-neutral-700 hover:text-neutral-900 focus:text-neutral-900 dark:text-neutral-400 dark:hover:text-neutral-200"
            ...
            <Button 
              type="submit"
              className="w-full bg-neutral-800 hover:bg-neutral-700 text-white rounded-sm h-11 shadow-sm hover:shadow-md transition-all duration-200 dark:bg-neutral-700 dark:hover:bg-neutral-600"
              disabled={isSubmitting}
          ...
          <Button 
            ...
            className="w-full bg-neutral-800 hover:bg-neutral-700 text-white hover:text-white rounded-sm h-11 shadow-sm hover:shadow-md transition-all duration-200 dark:bg-neutral-700 dark:hover:bg-neutral-600"
